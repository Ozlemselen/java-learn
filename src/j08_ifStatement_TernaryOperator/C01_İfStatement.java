...
public class C01_İfStatement {
    ...
    int ismlYas = 40;
        if (krmYas == ismlYas) {
                ...
                //if blokta kullanılmazsa ilk; e kadar olan yer çalışır.
...
/*bağımsız if statement yapıları sadece kndi kapsamlarını run eder.birden fazla bağımsız if statement yapıları
hepsinin body çAlışabilecegı gibi hiçbiride calısmayabilir
 */
